...
export default function AiPage() {
  return (
    <div className="h-[calc(100dvh-120px)] md:h-[calc(100dvh-144px)] -mt-6 -mx-4 md:-mx-6 border-none md:border md:rounded-[2.5rem] overflow-hidden bg-background flex flex-col shadow-2xl relative">

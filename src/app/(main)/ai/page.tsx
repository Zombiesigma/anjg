                            ...
                            <div>
                                ...
                                <div className="space-y-5">
                                    <div className="flex gap-4 group cursor-default">
                                        <div className="h-10 w-10 rounded-2xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center shrink-0 transition-transform group-hover:scale-110">
                                            <Zap className="h-5 w-5 text-orange-500" />
                                        </div>
                                        <div>
                                            <p className="text-xs font-black text-foreground/80">Ide Plot Cepat</p>
                                            <p className="text-[10px] text-muted-foreground leading-relaxed mt-1 font-medium">Susun kerangka cerita dalam hitungan detik.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 group cursor-default">
                                        <div className="h-10 w-10 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center shrink-0 transition-transform group-hover:scale-110">
                                            <PenTool className="h-5 w-5 text-blue-500" />
                                        </div>
                                        <div>
                                            <p className="text-xs font-black text-foreground/80">Kritik Sastra</p>
                                            <p className="text-[10px] text-muted-foreground leading-relaxed mt-1 font-medium">Analisis mendalam untuk draf karya Anda.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-4 group cursor-default">
                                        <div className="h-10 w-10 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center shrink-0 transition-transform group-hover:scale-110">
                                            <Sparkles className="h-5 w-5 text-emerald-500" />
                                        </div>
                                        <div>
                                            <p className="text-xs font-black text-foreground/80">Tips Literasi</p>
                                            <p className="text-[10px] text-muted-foreground leading-relaxed mt-1 font-medium">Panduan fitur dan cara menulis efektif.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                 ...
                 <div className="flex items-center justify-between px-6 h-16 border-b border-border/40 bg-background/95 backdrop-blur-md z-30 shrink-0 shadow-sm">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="font-black text-sm md:text-base tracking-tight uppercase">Ruang Inspirasi</h3>
                        </div>
                    </div>
                    <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary border border-primary/20">
                        <Star className="h-3 w-3 fill-current" />
                        <span className="text-[9px] font-black uppercase tracking-widest">Premium AI</span>
                    </div>
                </div>

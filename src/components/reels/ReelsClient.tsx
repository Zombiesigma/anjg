...
export function ReelsClient() {
  ...
  if (isLoading) {
    return (
      <div className="h-[calc(100dvh-120px)] md:h-[calc(100dvh-120px)] flex flex-col items-center justify-center gap-6 bg-zinc-950 md:rounded-[2.5rem] overflow-hidden">
  ...
  return (
    <div className="h-[calc(100dvh-120px)] md:h-[calc(100dvh-120px)] -mt-6 -mx-4 md:-mx-6 bg-black overflow-y-auto snap-y snap-mandatory no-scrollbar rounded-none md:rounded-[2.5rem] shadow-2xl relative scroll-smooth">
